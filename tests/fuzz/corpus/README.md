...
promotion; `../promote_corpus.sh` provides a dry run and an explicit
`--approve` step that minimizes against these seeds without overwriting them.
...
also makes reviewed seed changes explicit and reproducible.
