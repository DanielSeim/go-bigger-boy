...
inline constexpr std::array<VideoModeInfo, 8> video_modes{{
    ...
    {VideoMode::voxel_shape, "voxel_shape", "Voxel diorama (shape-aware)"},
    {VideoMode::voxel_popup, "voxel_popup", "Voxel pop-up book"},
}};
